...
variable "iam_policy_arns" {
  description = "A list of IAM policy ARNs to attach to the Lambda function"
  type        = list(string)
  default     = []
}

variable "iam_policy_jsons" {
  description = "A list of IAM policies to attach to the Lambda function"
  type        = list(string)
  default     = []
}
